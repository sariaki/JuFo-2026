...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{img/llvm-pass}
...
Das gleichzeitige Überschreiben einer Variable mit verschiedenen Werten durch zwei Threads \cite{colesaRandomRace}  \textcolor{red}{...} \\
