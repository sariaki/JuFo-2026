...
\begin{minipage}[t]{0.49\textwidth}
	...
	\label{fig:size}
\end{minipage}
Um die Obfuskationskosten zu messen wurde die Programmgröße, -laufzeit sowie die Kompilationszeit mit und ohne Obfuskation gemessen. Insgesamt bleiben die Kosten überschaubar. Die größten Auswirkungen hatte die Obfuskation auf die Kompilationszeit.
