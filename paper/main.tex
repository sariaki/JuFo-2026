...
\begin{algorithm}[!htb] 
    ...
    \For{$Function \; \Var{F} \in \Var{Module}$}
        \If{\Call{ShouldObfuscate}{$\Var{F}$}}
            ...
            \For{$i \gets \Var{DomainStart};\; i < \Var{DomainEnd};\; i \gets i + \Var{StepSize}$}
                \If{$\Call{CDF.EvaluateAt}{i} \ge 0.99$}
            ...
            \State $\Call{BB.InsertIf}{\Var{U} \le \Var{Threshold}, \Var{TrueBB}, \Var{FalseBB}}$
