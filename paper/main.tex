...
Um die Obfuskationskosten zu messen wurde die Programmgröße, -laufzeit sowie die Kompilationszeit mit und ohne Obfuskation gemessen. Insgesamt bleiben die Kosten überschaubar. Die größten Auswirkungen hatte die Obfuskation auf die Kompillationszeit. Unerwünschte Kosten in der Größe oder Laufzeit können durch ein Finetuning der Obfuskatoreinstellungen ausgeglichen werden, z.B. indem nur bestimmte Funktionen obfuskiert werden. 
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering
	\includegraphics[width=0.37\textwidth]{img/stats/size}
	\caption{Größe}
	\label{fig:size}
\end{wrapfigure}
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering
	\includegraphics[width=0.37\textwidth]{img/stats/compilation_time}
	\caption{Kompilationszeit}
...
\begin{wrapfigure}{r}{0.4\textwidth}
	...
	\caption{zyklomatische Komplexität (McCabe-Metrik)} 
	\label{fig:mcCabe}
\end{wrapfigure}
