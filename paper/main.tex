...
\begin{wrapfigure}{r}{0.32\textwidth}
	\centering
	\includegraphics[width=0.32\textwidth]{sym_exec}
...
Trotz der geringen Wahrscheinlichkeit eines Versagens der probabilistischen opaken Prädikate kompilieren und funktionieren auch größere Projekte wie SQLite problemlos/fehlerfrei (\cref{fig:passRate}).
