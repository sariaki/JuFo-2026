...
\begin{algorithm}[!htb] 
    ...
    \begin{algorithmic}[1]
    \Procedure{GenerateProbabilisticPredicates}{$\Var{Module}$}
    \For{$Function \; \Var{F} \in \Var{Modul}$}
    	\If{\Call{ShouldObfuscate}{$\Var{F}$}}
    		${U} \gets \Call{InsertSymbolicVariable}{$$}$
    	\EndIf
    \EndFor
    \EndProcedure
    \end{algorithmic}
