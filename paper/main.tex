...
\subsection{Fallbeispiel} \label{fallbsp}
\begin{figure}[!h]
	\centering 
...
Hervorzuheben ist, dass trotz der probabilistischen opaken Prädikate alle GNU Core Utilities fehlerfrei funktionierten. Hierfür wurde die Erfolgswahrscheinlichkeit $P(\Var{TrueBB})=0.99$ verwendet.
