...
Es wurden dabei die Programme aus \cite{banescuCodeObfuscationSymbolic2016}\footnote{https://github.com/tum-i4/obfuscation-benchmarks} sowie die GNU Core Utilities verwendet. % sowie ausgewählte Programme aus der NIST Juliet Test Suite v.1.3 \cite{NISTJuliet}
