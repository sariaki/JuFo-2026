...
\begin{algorithm}[!t] 
    ...
    \Procedure{GenerateProbabilisticPredicates}{$\Var{Module}, \Var{CDF}, \Var{p} \in [0, 1], \Var{StepCount} \in \mathbb{N}$}
...
\begin{algorithm}[!htb] 
	\caption{Berechnung der inversen kumulativen Verteilungsfunktion (PPF) über Newton–Raphson}
	\label{alg:invCumSum}
	\begin{algorithmic}[1]
...
Folgende Programme wurden obfuskiert: \textcolor{red}{TODO: ...}
Folgende symbolische Ausführungsengines wurden verwendet: \textcolor{red}{TODO: ...}
Alle Experimente wurden mit Ubuntu 24.04.3 und einer Intel\textregistered \;Core\texttrademark \;i7-10700F CPU ausgeführt.
Alle Programme wurden mit clang 18.0.0 kompilliert mit Optimierungslevel \texttt{-O3}.
