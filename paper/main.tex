...
\textcolor{red}{TODO: Programmgröße} \\
...
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering
	\includegraphics[width=0.37\textwidth]{img/stats/complexity}
...
Um die Resilienz zu messen wurden folgende Angriffsmethoden auf das einfache Programm aus \cref{fallbsp} angewandt: 
\begin{itemize}
...
Um die Tarnung quantitativ zu messen wurde die Verteilung an Programmanweisungen sowie die Entropie vor und nach der Obfuskation gemessen.
\begin{wrapfigure}{r}{0.4\textwidth}
	\centering
	\includegraphics[width=0.37\textwidth]{img/stats/opcode_dist}
	\caption{Programmanweisungverteilung vor/nach der Obfuskation} 
	\label{fig:opcodeDist}
\end{wrapfigure}
%\begin{wrapfigure}{r}{0.4\textwidth}
%	\centering
%	\includegraphics[width=0.37\textwidth]{img/stats/entropy}
%	\caption{Entropie} 
%	\label{fig:entropy}
%\end{wrapfigure}
