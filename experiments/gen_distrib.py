# cdf_monotone_compare.py
# Erzeugt Vergleichsplot: freies Polynom vs. monotone Fits (Isotonic, PCHIP, Bernstein)
# Benötigte Pakete: numpy, scipy, scikit-learn, matplotlib
