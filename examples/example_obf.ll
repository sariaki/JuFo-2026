...
define linkonce_odr dso_local i32 @sprintf(ptr noundef %0, ptr noundef %1, ...) #0 comdat {
  %3 = call i64 @sample_poisson(bfloat 0xR0085)
  %4 = icmp slt i64 %3, 0
...
define linkonce_odr dso_local i32 @vsprintf(ptr noundef %0, ptr noundef %1, ptr noundef %2) #0 comdat {
  %4 = call i64 @sample_poisson(bfloat 0xR00A6)
  %5 = icmp slt i64 %4, 0
...
define linkonce_odr dso_local i32 @_snprintf(ptr noundef %0, i64 noundef %1, ptr noundef %2, ...) #0 comdat {
  %4 = call i64 @sample_poisson(bfloat 0xR00C9)
  %5 = icmp slt i64 %4, 0
  br i1 %5, label %always_hit, label %never_hit
...
define linkonce_odr dso_local i32 @_vsnprintf(ptr noundef %0, i64 noundef %1, ptr noundef %2, ptr noundef %3) #0 comdat {
  %5 = call i64 @sample_poisson(bfloat 0xR00BF)
  %6 = icmp slt i64 %5, 0
...
define dso_local void @foo() #0 {
  %1 = call i64 @sample_poisson(bfloat 0xR00ED)
  %2 = icmp slt i64 %1, 0
...
define linkonce_odr dso_local i32 @printf(ptr noundef %0, ...) #0 comdat {
  %2 = call i64 @sample_poisson(bfloat 0xR00D2)
  %3 = icmp slt i64 %2, 0
...
define dso_local i32 @main() #0 {
  %1 = call i64 @sample_poisson(bfloat 0xR00E7)
  %2 = icmp slt i64 %1, 0
  br i1 %2, label %always_hit, label %never_hit
...
define linkonce_odr dso_local i32 @_vsprintf_l(ptr noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3) #0 comdat {
  %5 = call i64 @sample_poisson(bfloat 0xR00D9)
  %6 = icmp slt i64 %5, 0
  br i1 %6, label %always_hit, label %never_hit
...
define linkonce_odr dso_local i32 @_vsnprintf_l(ptr noundef %0, i64 noundef %1, ptr noundef %2, ptr noundef %3, ptr noundef %4) #0 comdat {
  %6 = call i64 @sample_poisson(bfloat 0xR0095)
  %7 = icmp slt i64 %6, 0
...
define linkonce_odr dso_local ptr @__local_stdio_printf_options() #0 comdat {
  %1 = call i64 @sample_poisson(bfloat 0xR00BA)
  %2 = icmp slt i64 %1, 0
  br i1 %2, label %always_hit, label %never_hit
...
define linkonce_odr dso_local i32 @_vfprintf_l(ptr noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3) #0 comdat {
  %5 = call i64 @sample_poisson(bfloat 0xR00D7)
  %6 = icmp slt i64 %5, 0
  br i1 %6, label %always_hit, label %never_hit
...
define i64 @sample_poisson(bfloat %u) {
entry:
  %0 = call i64 @sample_poisson(bfloat 0xR00BD)
  %1 = icmp slt i64 %0, 0
  br i1 %1, label %always_hit, label %never_hit

always_hit:                                       ; preds = %entry
  %p0 = call double @exp(double 0xR1AEC95BFF04578)
  br label %loop

loop:                                             ; preds = %loop, %always_hit
  %k = phi i64 [ 0, %always_hit ], [ %2, %loop ]
  %p = phi double [ %p0, %always_hit ], [ %5, %loop ]
  %s = phi double [ %p0, %always_hit ], [ %6, %loop ]
  %2 = add i64 %k, 1
  %3 = sitofp i64 %2 to double
  %4 = fdiv double 0xR1AEC95BFF04578, %3
  %5 = fmul double %p, %4
  %6 = fadd double %s, %5
  %7 = fpext bfloat %u to double
  %8 = fcmp ogt double %7, %s
