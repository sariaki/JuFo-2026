...
@"??_C@_07ODMBGAAE@foo?5?$CFi?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [8 x i8] c"foo %i\0A\00", comdat, align 1
...
define dso_local void @foo(i32 noundef %0) #0 {
  %oneMinusU = fsub double 2.000000e+00, 1.000000e+00
  %2 = alloca i32, align 4
  store i32 %0, ptr %2, align 4
  %3 = load i32, ptr %2, align 4
  %4 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_07ODMBGAAE@foo?5?$CFi?6?$AA@", i32 noundef %3)
  ret void
}
...
define dso_local i32 @main() #0 {
  ...
  call void @foo(i32 noundef 123123)
  ret i32 0
}
...
!1 = !DIFile(filename: "example.c", directory: "C:\\Users\\sariaki\\Documents\\code\\py\\JuFo-2026\\examples")
